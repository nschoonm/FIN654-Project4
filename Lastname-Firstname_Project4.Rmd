...
- The working capital account of \$250 million euro should be allocated as follows: buy \$21,438,648 million in nickel, \$113,727,083 million in copper, \$114,834,269 million in aluminium.
...
- Because our portfolio of accounts receivables in the various metals contains only risky assets, we chose the minimum variance portfolio in order to minimize the volatility of the overall portfolio.  Our goal here is to minimize the risk subject to our expected level of return.  We don’t think it is a good idea to put such a large amount of our portfolio into our new business adventure until we are able to produce and use the data from our own company insights to analyze how our decisions have affected our current business structure.  
  
How does your decision impact the business?

- We feel that our decision will have the smallest impact on our current business operations, while we test our entry into the nickel market.  The capital reserves for this portfolio will be very similar to our current reserves other than a slight increase for the added risk of nickel.  In other words, we would not need to restructure our wealth significantly as with the other portfolios that carry more risk. In addition, the weights were all positive and would not result in any assets being short sold. We would not be borrowing any money from a broker or customer.

What are your recommendations?

- Our portfolio management strategy considers the uncertainty and volatility of these commodities.   As we scale our efforts to diversify our portfolio, we will keep a close watch on market risk which includes volatility in prices and global events that could impact our supply chain.  In addition, we will continue to monitor the volatility of our current commodity mix and make necessary adjustments to cargo loads, by assigning the weights that will maximize performance.  In portfolio management there is careful consideration to make considerable efforts to determine the impact of extremes and outliers in our data analysis.  Extremes help us create contingency plans around these rare data points and help us predict a future trend in price or volatility that will impact our performance.  Moving forward we will continue to gather and analyze data to support any decision to change our current strategy.
